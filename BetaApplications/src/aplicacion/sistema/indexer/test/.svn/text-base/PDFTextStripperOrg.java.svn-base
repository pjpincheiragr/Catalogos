 ...
 */
public class PDFTextStripperOrg extends PDFStreamEngine
{
     ...
     */
    public PDFTextStripperOrg() throws IOException
    {
     ...
     */
    public PDFTextStripperOrg( Properties props ) throws IOException
    {
        super( props );
        this.outputEncoding = null;
        normalize = new TextNormalize(this.outputEncoding);
     ...
     * @throws IOException If there is an error reading the properties.
     */
    public PDFTextStripperOrg( String encoding ) throws IOException
    {
        super( ResourceLoader.loadProperties( "Resources/PDFTextStripper.properties", true ));
