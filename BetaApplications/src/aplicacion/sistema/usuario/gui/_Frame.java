...
public class _Frame extends JFrame {
	...
	private JTextField _txt_negocio_descripcion = null;
	/**
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel411.setBounds(new Rectangle(12, 137, 83, 18));
			jLabel411.setText("unegocio");
			jLabel411.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel41 = new JLabel();
			jLabel41.setBounds(new Rectangle(13, 163, 81, 18));
			jLabel41.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel41.setText("iddeposito");
			...
			jContentPane.add(get_txt_negocio_descripcion(), null);
		}
		return jContentPane;
	}
	...
	private JTabbedPane getJTabbedPane() {
		if (jTabbedPane == null) {
			...
			jTabbedPane.setBounds(new Rectangle(15, 210, 496, 192));
	...
	public JTextField get_txt_iddeposito() {
		if (_txt_iddeposito == null) {
			...
			_txt_iddeposito.setBounds(new Rectangle(100, 166, 88, 17));
		}
	...
	public JTextField get_txt_deposito_descripcion() {
		if (_txt_deposito_descripcion == null) {
			...
			_txt_deposito_descripcion.setBounds(new Rectangle(192, 167, 191, 14));
	...
	/**
	 * This method initializes _txt_negocio	
	 * 	
	 * @return javax.swing.JTextField	
	 */
	public JTextField get_txt_negocio() {
		if (_txt_negocio == null) {
			...
			_txt_negocio.setBounds(new Rectangle(103, 139, 83, 19));
		}
		return _txt_negocio;
	}

	/**
	 * This method initializes _txt_negocio_descripcion	
	 * 	
	 * @return javax.swing.JTextField	
	 */
	public JTextField get_txt_negocio_descripcion() {
		if (_txt_negocio_descripcion == null) {
			_txt_negocio_descripcion = new JTextField();
			_txt_negocio_descripcion.setBounds(new Rectangle(190, 140, 204, 19));
			_txt_negocio_descripcion.setEditable(false);
		}
		return _txt_negocio_descripcion;
	}
