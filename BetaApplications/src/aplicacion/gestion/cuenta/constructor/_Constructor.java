 ...
 * 
 */
package aplicacion.gestion.cuenta.constructor;

import aplicacion.modelo.constructor.Constructor;
import aplicacion.modelo.interfaces._parametros;
import aplicacion.gestion.cuenta.events.*;
...
public class _Constructor extends Constructor{
	...
	public void initialize_components(){
		...
		_frame.get_txt_cuenta().setName(_Interface._txt_cuenta);
	...
	public void init(){
		...
		if (cuenta!=null){
			if (cuenta.compareTo("")!=0){
				_frame.get_txt_cuenta().setText(cuenta);
				_logic._evaluar_codigo_cuenta(_frame.get_txt_cuenta());
			}
		}
	}
