...
public class Rechazodos_Asiento  extends Logic_Extension {
	...
	public void GenerarAsientodePago(){
		...
		//System.out.println("Asiento");
			...
			if (!error){
				JOptionPane.showMessageDialog(frame, "El Ingreso fue Grabado Correctamente");
				((_Logic) this._logic).clean();
			}else {
				JOptionPane.showMessageDialog(frame, "Error al Grabar Ingreso");
			}	
