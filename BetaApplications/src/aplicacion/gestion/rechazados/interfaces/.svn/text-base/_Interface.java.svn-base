package aplicacion.gestion.rechazados.interfaces;

public interface _Interface {
	public String _list_cajas="_list_cajas";
	...
	public String _extension_medios_de_pago="Rechazados_Medios_de_Pago";
	public String _extension_asiento="Rechazados_Asiento";
}
