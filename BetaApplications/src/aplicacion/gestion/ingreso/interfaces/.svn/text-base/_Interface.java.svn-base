package aplicacion.gestion.ingreso.interfaces;
...
public interface _Interface {
	...
	public String _extension_medios_de_pago="Ingreso_Medios_de_Pago";
	public String _extension_asiento="Ingreso_Asiento";
}
