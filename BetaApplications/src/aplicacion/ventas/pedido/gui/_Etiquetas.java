...
public class _Etiquetas extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(32, 328, 64, 14));
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jPanel.setBounds(new Rectangle(12, 33, 604, 290));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(15, 33, 571, 228));
	...
	public JTextField get_txt_unidades() {
		if (_txt_unidades == null) {
			...
			_txt_unidades.setBounds(new Rectangle(105, 327, 71, 17));
	...
	private JToolBar getJToolBar() {
		if (jToolBar == null) {
			...
			jToolBar.setSize(new Dimension(632, 24));
