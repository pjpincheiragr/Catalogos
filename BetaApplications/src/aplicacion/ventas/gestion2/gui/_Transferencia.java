...
public class _Transferencia extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(5, 79, 69, 18));
	...
	public JTextField get_txt_idvendedor() {
		if (_txt_idvendedor == null) {
			...
			_txt_idvendedor.setBounds(new Rectangle(75, 79, 54, 19));
	...
	public JTextField get_txt_vendedor_descripcion() {
		if (_txt_vendedor_descripcion == null) {
			...
			_txt_vendedor_descripcion.setBounds(new Rectangle(131, 79, 170, 19));
	...
	private JTabbedPane getJTabbedPane() {
		if (jTabbedPane == null) {
			...
			jTabbedPane.setBounds(new Rectangle(3, 101, 743, 271));
	...
	private JLabel getJLabel1() {
		if (jLabel1 == null) {
			...
			jLabel1.setBounds(new Rectangle(5, 55, 70, 20));
		}
		return jLabel1;
	}
	...
	public JTextField get_txt_idcreador() {
		if (_txt_idcreador == null) {
			...
			_txt_idcreador.setLocation(new Point(75, 55));
	...
	public JTextField get_txt_creador_detalle() {
		if (_txt_creador_detalle == null) {
			...
			_txt_creador_detalle.setBounds(new Rectangle(131, 55, 169, 20));
