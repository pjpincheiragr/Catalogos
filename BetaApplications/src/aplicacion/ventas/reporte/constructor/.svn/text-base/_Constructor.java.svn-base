 ...
 * 
 */
package aplicacion.ventas.reporte.constructor;

import aplicacion.modelo.constructor.Constructor;
import aplicacion.modelo.interfaces._parametros;
import aplicacion.ventas.reporte.events.*;
import aplicacion.ventas.reporte.gui.*;
...
public class _Constructor extends Constructor{
	...
	public void initialize_components(){
		...
		_frame.get_list_reportes().setName(_Interface._list_reportes);
