package aplicacion.actualizacion.alias.gui;
...
public class _Frame extends JFrame {
	...
	private JTextField _txt_aftercode = null;
	...
	private JCheckBox _chk_comienzo = null;
	/**
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			jLabel3 = new JLabel();
			jLabel3.setBounds(new Rectangle(504, 41, 133, 14));
	...
	public JTextField get_txt_aftercode() {
		if (_txt_aftercode == null) {
			_txt_aftercode = new JTextField();
			_txt_aftercode.setBounds(new Rectangle(196, 75, 70, 16));
			_txt_aftercode.setToolTipText("Post Codigo");
		}
		return _txt_aftercode;
	}
	/**
	...
	private JPanel getJPanel_opciones() {
		if (jPanel_opciones == null) {
			...
			jPanel_opciones.add(get_txt_aftercode(), null);
			...
			jPanel_opciones.add(get_chk_comienzo(), null);
		}
	 ...
	 * @return javax.swing.JTextField	
	 */
	public JTextField get_txt_prefijo() {
		if (_txt_prefijo == null) {
			_txt_prefijo = new JTextField();
			_txt_prefijo.setBounds(new Rectangle(344, 38, 100, 17));
	...
	public JCheckBox get_chk_precargar_codigos() {
		if (_chk_precargar_codigos == null) {
			...
			_chk_precargar_codigos.setBounds(new Rectangle(285, 76, 290, 16));
	...
	/**
	 * This method initializes _chk_comienzo	
	 * 	
	 * @return javax.swing.JCheckBox	
	 */
	public JCheckBox get_chk_comienzo(){
		if (_chk_comienzo == null) {
			_chk_comienzo = new JCheckBox();
			_chk_comienzo.setBounds(new Rectangle(342, 7, 108, 17));
			_chk_comienzo.setFont(new Font("Dialog", Font.PLAIN, 10));
			_chk_comienzo.setToolTipText("Codigos que comiencen con..");
			_chk_comienzo.setText("Comienzo");
		}
		return _chk_comienzo;
	}
