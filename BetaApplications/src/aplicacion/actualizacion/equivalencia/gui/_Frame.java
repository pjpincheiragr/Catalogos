package aplicacion.actualizacion.equivalencia.gui;
...
public class _Frame extends JFrame {
	...
	private void initialize() {
		...
		this.setTitle("Cargar Equivalencias por Archivo");
	}
	...
	public JTextField get_txt_archivo() {
		if (_txt_archivo == null) {
			...
			_txt_archivo.setBounds(new Rectangle(170, 148, 335, 19));
	...
	public JButton get_btn_buscar_archivo() {
		if (_btn_buscar_archivo == null) {
			...
			_btn_buscar_archivo.setBounds(new Rectangle(507, 149, 22, 19));
	...
	public JButton get_btn_columnas() {
		if (_btn_columnas == null) {
			...
			_btn_columnas.setBounds(new Rectangle(9, 176, 22, 19));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(18, 227, 789, 117));
	...
	public JButton get_btn_cargar_archivo() {
		if (_btn_cargar_archivo == null) {
			...
			_btn_cargar_archivo.setBounds(new Rectangle(532, 149, 22, 19));
	...
	public JProgressBar getJProgressBar() {
		if (jProgressBar == null) {
			...
			jProgressBar.setBounds(new Rectangle(38, 176, 545, 19));
