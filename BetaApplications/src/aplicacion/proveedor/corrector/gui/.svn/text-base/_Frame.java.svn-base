package aplicacion.proveedor.corrector.gui;
...
public class _Frame extends JFrame {
	...
	public JTextField get_txt_idproveedor() {
		if (_txt_idproveedor == null) {
			...
			_txt_idproveedor.setBounds(new Rectangle(7, 48, 116, 17));
		}
	...
	public JTextField get_txt_descripcion_proveedor() {
		if (_txt_descripcion_proveedor == null) {
			...
			_txt_descripcion_proveedor.setBounds(new Rectangle(149, 48, 272, 17));
