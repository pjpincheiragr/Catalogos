package aplicacion.proveedor.reporte.gui;
...
public class _Frame extends JFrame {
	...
	private void initialize() {
		...
		this.setTitle("Reporte de Proveedor");
	}
	...
	public JTextField get_txt_idproveedor() {
		if (_txt_idproveedor == null) {
			...
			_txt_idproveedor.setBounds(new Rectangle(87, 66, 113, 18));
	...
	public JTextField get_txt_proveedor_descripcion() {
		if (_txt_proveedor_descripcion == null) {
			...
			_txt_proveedor_descripcion.setBounds(new Rectangle(225, 65, 230, 18));
	...
	public JButton get_btn_buscar_proveedor() {
		if (_btn_buscar_proveedor == null) {
			...
			_btn_buscar_proveedor.setBounds(new Rectangle(200, 66, 21, 18));
			_btn_buscar_proveedor.setToolTipText("Buscar Cliente");
