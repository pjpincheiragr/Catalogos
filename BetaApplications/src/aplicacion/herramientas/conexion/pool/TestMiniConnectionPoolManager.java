package aplicacion.herramientas.conexion.pool;
...
private static final int                  noOfThreads      = 5;    // number of worker threads
private static final int                  processingTime   = 3;    // total processing time of the test program in seconds
...
private static ConnectionPoolDataSource createDataSource() throws Exception {
   ...
   */
   ...
   // Version for JTDS:
      ...
      dataSource.setDatabaseName ("cwisky");
      dataSource.setServerName ("localhost");
      dataSource.setUser ("sa");
      dataSource.setPassword ("ernest");
