...
public class Test {
	...
	public MsSQL getMsSQL(){
		...
		s.setId("MsSQL");
		s.setDatabase("NEUQUEN2013;instance=alfanet;");
		s.setUser("NEUQUEN2013");
		s.setPassword("NEUQUEN2013");
		s.setHost("192.168.4.4");
		return s;
	}
	...
	public boolean tester(ConnectionHandler c){
		boolean error=false;
		try {
			Connection con=c.getConnector("MsSQL").getConnection();
