...
public class _Frame extends JFrame {
	...
	private JTextField _txt_instance = null;
	/**
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel91 = new JLabel();
			jLabel91.setBounds(new Rectangle(17, 162, 109, 17));
			jLabel91.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel91.setText("instance");
			jLabel91.setFont(new Font("Dialog", Font.PLAIN, 10));
			jLabel12 = new JLabel();
			jLabel12.setBounds(new Rectangle(18, 233, 106, 16));
			...
			jLabel5 = new JLabel();
			jLabel5.setBounds(new Rectangle(18, 210, 106, 15));
			jLabel5.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel5.setFont(new Font("Dialog", Font.PLAIN, 10));
			jLabel5.setText("password");
			jLabel4 = new JLabel();
			jLabel4.setBounds(new Rectangle(19, 188, 104, 15));
			...
			jContentPane.add(get_txt_instance(), null);
		}
		return jContentPane;
	}
	...
	public JTextField get_txt_usuario() {
		if (_txt_usuario == null) {
			...
			_txt_usuario.setBounds(new Rectangle(134, 186, 130, 16));
	...
	public JPasswordField get_txt_password() {
		if (_txt_password == null) {
			...
			_txt_password.setBounds(new Rectangle(134, 211, 130, 16));
	...
	public JComboBox get_lst_mysql() {
		if (_lst_mysql == null) {
			...
			_lst_mysql.setBounds(new Rectangle(134, 233, 129, 16));
	...
	/**
	 * This method initializes _txt_instance	
	 * 	
	 * @return javax.swing.JTextField	
	 */
	public JTextField get_txt_instance() {
		if (_txt_instance == null) {
			_txt_instance = new JTextField();
			_txt_instance.setBounds(new Rectangle(135, 163, 128, 14));
			_txt_instance.setFont(new Font("Dialog", Font.PLAIN, 10));
		}
		return _txt_instance;
	}
