...
/*
 * Javier Abelln. 12 de noviembre de 2003
 *
 * EditorTabla.java
 *
 */
...
public class EditorTabla extends JComboBox implements TableCellEditor
 {
     ...
     public EditorTabla()
     {
         ...
         // Nos apuntamos a la prdida de foco, que quiere decir que se ha
         // dejado de editar la celda, sin aceptar ninguna opci�n. Avisamos
         // a la tabla de la cancelacin de la edicin.
     ...
     public void addCellEditorListener(CellEditorListener l) {
         // Se aade el suscriptor a la lista.
         suscriptores.add (l);
     }
     ...
     public Object getCellEditorValue() {
         ...
         // Se obtiene la opcn del combo box elegida y se devuelve un
         // Integer adecuado.
         ...
         // Devolvemos null si no nos gusta la eleccn del men.
         return null;
     }
     ...
     public boolean stopCellEditing() {
         // Indica si se puede detener la edicin.
         return true;
     }
 
     /**
      * Si cambiado es true, se avisa a los suscriptores de que se ha terminado
      * la edicin. Si es false, se avisa de que se ha cancelado la edicin.
      */
