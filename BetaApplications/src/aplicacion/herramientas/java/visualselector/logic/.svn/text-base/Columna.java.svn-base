...
public class Columna {
	...
	private JComboBox columnList=null;
	...
	public void setAligment(int alignment){
	...
	public void setColumnList(JComboBox column){
		System.out.println("Set ColumnList>"+column);
