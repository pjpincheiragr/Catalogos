package aplicacion.flota.proveedor.logic;
...
public class DragImage {
  ...
  public static void main(String args[]) {
    ...
    Icon icon = new ImageIcon("E:/AGUSTINCATALOGOS/Catalogo ANS/Imagenes/SKF/ARTICULOS/vkm 02022.jpg");
    ...
    clear.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent actionEvent) {
    	  System.out.println("Event> "+actionEvent.getID());
        label.setIcon(null);
      }
    });
