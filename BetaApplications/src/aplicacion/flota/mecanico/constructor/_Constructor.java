package aplicacion.flota.mecanico.constructor;

import aplicacion.modelo.constructor.Constructor;
import aplicacion.flota.mecanico.events.ActionListenerHandler;
import aplicacion.flota.mecanico.events.WindowAdapterHandler;
import aplicacion.flota.mecanico.events.KeyListenerHandler;
import aplicacion.flota.mecanico.gui._Frame;
import aplicacion.flota.mecanico.interfaces.*;
import aplicacion.flota.mecanico.logic._Data;
import aplicacion.flota.mecanico.logic._Logic;
import aplicacion.flota.mecanico.interfaces._Interface;
import aplicacion.flota.mecanico.events.DropTargetListenerHandler;
...
public class _Constructor extends Constructor {
	...
	public void initialize_components(){
		...
		frame.get_txt_idmecanico().setName(_Interface._txt_idmecanico);
